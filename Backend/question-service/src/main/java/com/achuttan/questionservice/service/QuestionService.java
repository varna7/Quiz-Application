package com.achuttan.questionservice.service;
...
import com.achuttan.questionservice.dao.QuestionDao;
...
public class QuestionService {
	...
	public ResponseEntity<String> addQuestion(Question question) {
		...
		return new ResponseEntity<String>("Failed to add new question",HttpStatus.BAD_REQUEST);
	}
